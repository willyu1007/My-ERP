...
export const STANDARD_CASH_FLOW_ITEMS: readonly CashFlowItemSeed[] = [
  // 经营活动
  { code: 'OP-IN-1', name: '销售商品、提供劳务收到的现金', activity: 'operating', direction: 'inflow' },
  { code: 'OP-IN-2', name: '收到的税费返还', activity: 'operating', direction: 'inflow' },
  { code: 'OP-IN-3', name: '收到其他与经营活动有关的现金', activity: 'operating', direction: 'inflow' },
  { code: 'OP-OUT-1', name: '购买商品、接受劳务支付的现金', activity: 'operating', direction: 'outflow' },
  { code: 'OP-OUT-2', name: '支付给职工以及为职工支付的现金', activity: 'operating', direction: 'outflow' },
  { code: 'OP-OUT-3', name: '支付的各项税费', activity: 'operating', direction: 'outflow' },
  { code: 'OP-OUT-4', name: '支付其他与经营活动有关的现金', activity: 'operating', direction: 'outflow' },
  // 投资活动
  { code: 'IV-IN-1', name: '收回投资、取得投资收益收到的现金', activity: 'investing', direction: 'inflow' },
  { code: 'IV-IN-2', name: '处置固定资产、无形资产收回的现金', activity: 'investing', direction: 'inflow' },
  { code: 'IV-OUT-1', name: '购建固定资产、无形资产支付的现金', activity: 'investing', direction: 'outflow' },
  ...
  { code: 'FN-OUT-2', name: '分配股利、利润或偿付利息支付的现金', activity: 'financing', direction: 'outflow' },
];
